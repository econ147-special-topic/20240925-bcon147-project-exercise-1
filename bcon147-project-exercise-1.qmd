...
- Use a correlation matrix or heatmap to visualize the relationship between these variables and attrition.
...
```{r}
## install the corrplot package and use the corrplot 
```
